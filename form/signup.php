...
<html>
<head>
	<title>Signup - Hamro School</title>
...
<body>
	...
	<div class="row">
		...
		<div class="col-sm-4 col-md-4">
			<h1 style="color:red; text-align: center;">Hamro <span class="h1_school" style="color: blue;">School</span></h1>
		</div>
		...
		<?php } else { ?>
			...
			<form action="" method="POST">
			  ...
			  <button type="submit" class="btn btn-primary btn-group-lg form_btn" name="signup">SignUp</button>
