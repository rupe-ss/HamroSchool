...
require_once("config.php");
		...
		$selectquery= "select * from tupload where usertype='student' ";
...
<html>
<head>
	<title>Student Uploaded Assignment</title>
...
<body>
	...
	<div class="container" style="padding:20px; background-color: blue;">
		<h2 style="text-align: center; color:#ffffff;"> Assignment Uploaded by Students</h2>
